Опыт во фронтенде более двух лет на React + TS. Cейчас перехожу в бэкенд. Опыт backend разработки пока только в рамках обучения на Hexslet. Навыки полученные за время обучения:
* Python
* PyTest
* SQL
* Django
