Опыт во фронте более двух лет на React + TS. Cейчас перехожу в бэкенд. **Рассматриваю вакансии Python backend или fullstack**. Опыт backend разработки пока только в рамках обучения на Hexslet. Навыки полученные за время обучения:
* Python
* PyTest
* SQL
* Django
